...
| VC: ディールフロー | Fast screen→Due diligence | Stage 3でthesis fit評価 | LinkedIn/GoingVC |
...
1. **データ品質検証**: 結合5分足197日の整合性確認
2. **utils.py作成**: Agent共通の計算コード
3. **検出力分析**: N=197/1256で検出可能な効果量の確認

...
- **市況（2026-09-17 18:07 JST）**: SOXL プレ $110.00（9/16 終値 $103.97 比 +5.8%）、SOXX +1.86%、QQQ +1.13%。FOMC は 25bp 利上げ（3.75〜4.00%、SEP は年内もう1回）。regime は 2026-09-17 付 risk_on 0.64（イールドカーブが normal→flat）。
- **データ鮮度（2026-09-18 11:25 JST 時点）**: マクロは 9/17 まで、日足・5分足は 9/16 米引けまで。フィラデルフィア連銀 9月調査（events id 475、9/17 21:30 JST）の結果と、9/18 昼の日銀の結果は未確認。
- **カタリスト**: 9/18 昼 日銀（1.25% 利上げ観測）→ 9/24 米中首脳会談 → 10/1 早朝 Micron 決算。
- **参照**: K-041/K-055/K-072/K-074/K-083、ADR-027/ADR-028。実施記録は #46、開いている作業は issue #27/#31/#37/#38/#39/#40/#42。
